...
parser.add_argument('--root_path', type=str, default='../data/LiTS',
...
dice_loss = lossess.DiceLoss(n_classes=3)
...
def patients_to_slices(dataset, patiens_num):
    ...
    if "ACDC" in dataset:
        ...
        ref_dict = {"2": 47, "3":93, "4": 111, "7":191,"8": 238,
                    "12": 351, "16": 438, "21": 563, "30": 795, "35": 940}
    else:
        print("Error")
...
def self_train(args, pre_snapshot_path_u, pre_snapshot_path_k, snapshot_path_u, snapshot_path_k):
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            #writer.add_scalar('info/contrastive_loss', contrastive_loss, iter_num)
...
if __name__ == "__main__":
    ...
    # -- path to save models
    pre_snapshot_path_u = "./model/MCMCCL/Prostate_{}_{}_labeled/pre_train_u".format(args.exp, args.labelnum)
    pre_snapshot_path_k = "./model/MCMCCL/Prostate_{}_{}_labeled/pre_train_k".format(args.exp, args.labelnum)
    self_snapshot_path_u = "./model/MCMCCL/Prostate_{}_{}_labeled/self_train_u".format(args.exp, args.labelnum)
    self_snapshot_path_k = "./model/MCMCCL/Prostate_{}_{}_labeled/self_train_k".format(args.exp, args.labelnum)

    for snapshot_path in [pre_snapshot_path_u, pre_snapshot_path_k, self_snapshot_path_u, self_snapshot_path_k]:
        if not os.path.exists(snapshot_path):
            os.makedirs(snapshot_path)
    shutil.copy('../code/Promise_train.py', self_snapshot_path_u)
    shutil.copy('../code/Promise_train.py', pre_snapshot_path_k)
